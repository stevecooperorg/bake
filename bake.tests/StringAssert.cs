...
namespace NUnit.Framework
{
    public static class StringAssert
    {
        ...
        [DebuggerStepThrough()]
        public static void HaveTrimmedContent(this string actual, string expected)
        {
        ...
        private static void StartMergeProgram(string expected, string actual)
        {
            ...
            if (mergeProgram != null)
            {
...

                {
                    ...
                    testName = "test" + new Guid(md5.ComputeHash(Encoding.ASCII.GetBytes(testName))).ToString("N");
